...
def isSusceptibleSA(t, s,
                    states, events, T, output_signals, SAF, MafterGrid,	#	MafterGrid=0.001
...
def isMasked(s, tfrom, monitored_states,
    ...
    times_SAF, states_SAF = tr.traceSA(states[0], events_check, output_signals, SA_signal=s, SA_value=SAF, SA_time=t+MafterGrid,
                                T=T, snk_delay=snk_delay, src_delay=src_delay,
