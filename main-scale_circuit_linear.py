...
for i in range(1, num_stages+1):
    ...
    for j in range(num_bits):
        ...
        if (i == 1):
            # c_a1F[0]
            tr.rise(f=tr.Cr, i=[f'aF[{j}]', 'en{i}'], o=f'ca{i}F[{j}]', d=5)
            tr.fall(f=tr.Cf, i=[f'aF[{j}]', 'en{i}'], o=f'ca{i}F[{j}]', d=5)

            # c_a1T[0]
            tr.rise(f=tr.Cr, i=[f'aT[{j}]', 'en{i}'], o=f'ca{i}T[{j}]', d=5)
            tr.fall(f=tr.Cf, i=[f'aT[{j}]', 'en{i}'], o=f'ca{i}T[{j}]', d=5)
            
            
            # c_b1F[0]
            tr.rise(f=tr.Cr, i=[f'bF[{j}]', 'en{i}'], o=f'cb{i}F[{j}]', d=5)
            tr.fall(f=tr.Cf, i=[f'bF[{j}]', 'en{i}'], o=f'cb{i}F[{j}]', d=5)

            # c_b1T[0]
            tr.rise(f=tr.Cr, i=[f'bT[{j}]', 'en{i}'], o=f'cb{i}T[{j}]', d=5)
            tr.fall(f=tr.Cf, i=[f'bT[{j}]', 'en{i}'], o=f'cb{i}T[{j}]', d=5)
...
ret = check.check(times=times, events=events, states=states, signals=list(init.keys()), output_signals=['ca3F', 'ca3T', 'cb3F', 'cb3T', 'ackout'])
pprint.pprint(ret)
