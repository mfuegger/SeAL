...
def GeneratePipeline():
    ...
    tr.rise(f=tr.Cr, i=['half_adder__a(0).F', 'half_adder__b(0).F'], o='half_adder__aFbF', d=5)
    tr.fall(f=tr.Cf, i=['half_adder__a(0).F', 'half_adder__b(0).F'], o='half_adder__aFbF', d=5)

    tr.rise(f=tr.Cr, i=['half_adder__a(0).F', 'half_adder__b(0).T'], o='half_adder__aFbT', d=5)
    tr.fall(f=tr.Cf, i=['half_adder__a(0).F', 'half_adder__b(0).T'], o='half_adder__aFbT', d=5)

    tr.rise(f=tr.Cr, i=['half_adder__a(0).T', 'half_adder__b(0).F'], o='half_adder__aTbF', d=5)
    tr.fall(f=tr.Cf, i=['half_adder__a(0).T', 'half_adder__b(0).F'], o='half_adder__aTbF', d=5)

    tr.rise(f=tr.Cr, i=['half_adder__a(0).T', 'half_adder__b(0).T'], o='r2__sum_in(1).T', d=5)
    tr.fall(f=tr.Cf, i=['half_adder__a(0).T', 'half_adder__b(0).T'], o='r2__sum_in(1).T', d=5)

    tr.rise(f=tr.ORr, i=['half_adder__aFbF', 'r2__sum_in(1).T'], o='r2__sum_in(0).F', d=6)
    tr.fall(f=tr.ORf, i=['half_adder__aFbF', 'r2__sum_in(1).T'], o='r2__sum_in(0).F', d=6)

    tr.rise(f=tr.ORr, i=['half_adder__aTbF', 'half_adder__aFbT'], o='r2__sum_in(0).T', d=6)
    tr.fall(f=tr.ORf, i=['half_adder__aTbF', 'half_adder__aFbT'], o='r2__sum_in(0).T', d=6)

    tr.rise(f=tr.ORr, i=['half_adder__a(0).F', 'half_adder__b(0).F'], o='r2__sum_in(1).F', d=6)
    tr.fall(f=tr.ORf, i=['half_adder__a(0).F', 'half_adder__b(0).F'], o='r2__sum_in(1).F', d=6)
    ...
    output_signals = ['chin_ack', 'chout_sum(0).F', 'chout_sum(0).T', 'chout_sum(1).F', 'chout_sum(1).T',]
